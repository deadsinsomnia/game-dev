...
@onready var sfx_attack_1: AudioStreamPlayer2D = $sfx_attack1
@onready var sfx_damage: AudioStreamPlayer2D = $sfx_damage
@onready var sfx_dodge: AudioStreamPlayer2D = $sfx_dodge
...
func _physics_process(delta):
	...
	if is_dodging:
		...
		if Input.is_action_just_pressed("dodge") and direction != 0:
			is_dodging = true
